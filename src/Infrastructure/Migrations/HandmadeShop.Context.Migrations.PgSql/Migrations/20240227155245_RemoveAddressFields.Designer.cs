...
namespace HandmadeShop.Context.Migrations.PgSql.Migrations
{
    ...
    [Migration("20240227155245_RemoveAddressFields")]
    partial class RemoveAddressFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HandmadeShop.Domain.Buyer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HandmadeShop.Domain.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HandmadeShop.Domain.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HandmadeShop.Domain.Order", b =>
                {
                    b.HasOne("HandmadeShop.Domain.Buyer", "Buyer")
                        .WithOne("Order")
                        .HasForeignKey("HandmadeShop.Domain.Order", "BuyerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("HandmadeShop.Domain.Address", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("HandmadeShop.Domain.OrderItem", b =>
                {
                    b.HasOne("HandmadeShop.Domain.Order", "Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
