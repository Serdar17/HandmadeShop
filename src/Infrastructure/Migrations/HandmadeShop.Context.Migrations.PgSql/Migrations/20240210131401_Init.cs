        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_user_roles_claims_user_roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_roles_owners", x => new { x.UserId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_user_roles_owners_user_roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "user_roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_user_roles_owners_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_users_likes", x => new { x.LikesId, x.UsersId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_roles_claims_RoleId",
                table: "user_roles_claims",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_user_roles_owners_RoleId",
                table: "user_roles_owners",
                column: "RoleId");
